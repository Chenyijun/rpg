 ...
 */
var connection_string = 'localhost:27017/RPG';
/*
...
exports.remove = function(collection, remove, justOne, callback) {
  mongoDB
    .collection(collection)     // The collection to update
    .remove(                
      remove,                   // Filter selects which documents to remove
      justOne,                   // True if removing single document
      function(err, status) {   // Callback upon error or success
        if (err) doError(err);
